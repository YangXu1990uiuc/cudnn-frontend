...
class ReductionNode : public NodeCRTP<ReductionNode> {
   public:
    ...
    create_cudnn_operations(
        ...
        CHECK_CUDNN_STATUS(reduction_descriptor.initialize_managed_backend_pointer(CUDNN_BACKEND_REDUCTION_DESCRIPTOR),
        ...
        CHECK_CUDNN_STATUS(detail::convert_to_cudnn_type(attributes.compute_data_type, cudnn_data_type),
                          "CUDNN_BACKEND_REDUCTION_DESCRIPTOR: convert compute type failed");
        CHECK_CUDNN_STATUS(detail::set_attribute(reduction_descriptor.get_raw_desc(),
        ...
        CHECK_CUDNN_STATUS(detail::convert_to_cudnn_type(attributes.get_mode().value(), cudnn_reduction_mode),
                          "CUDNN_BACKEND_REDUCTION_DESCRIPTOR: convert reduction mode failed");
        CHECK_CUDNN_STATUS(detail::set_attribute(reduction_descriptor.get_raw_desc(),
        ...
        CHECK_CUDNN_STATUS(detail::finalize(reduction_descriptor.get_raw_desc()),
        ...
        CHECK_CUDNN_STATUS(reduction_operation.initialize_managed_backend_pointer(CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR),
        ...
        CHECK_CUDNN_STATUS(detail::set_attribute(reduction_operation.get_raw_desc(),
        ...
        CHECK_CUDNN_STATUS(detail::finalize(reduction_operation.get_raw_desc()),
